...
public class AdminProfileView extends JPanel implements ActionListener, MouseListener  {
    ...
    private JLabel UserNameLabel,ContactNoLabel,DOBLabel,AgeLabel,JoinDateLabel,PAddressLabel,TAddressLabel,MaritalStatusLabel,DesignationLabel, ExperienceLabel, GenderLabel, SalaryLabel;
